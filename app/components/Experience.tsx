export default function Experience() {
  return (
    <section id="experience" className="border-2 border-sky-500 fade-in-up glow-cyan">
      <h2 className="text-3xl font-semibold mb-6 text-sky-400">Experience</h2>

      <div className="space-y-10">

        <div className="border border-sky-600 rounded-lg p-4 bg-gray-700/50 hover:bg-gray-700/70 transition-all duration-300">
          <h3 className="text-xl font-medium text-sky-300">Data Engineer — Stryker (via TCS)</h3>
        ...
        <div className="border border-sky-600 rounded-lg p-4 bg-gray-700/50 hover:bg-gray-700/70 transition-all duration-300">
          <h3 className="text-xl font-medium text-sky-300">Software Developer & Workflow Specialist — CoreLogic (via TCS)</h3>
