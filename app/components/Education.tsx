export default function Education() {
  return (
    <section id="education" className="border-2 border-teal-500 fade-in-up glow-teal">
      <h2 className="text-3xl font-semibold mb-6 text-teal-400">Education</h2>

      <div className="space-y-6">
        <div className="border border-teal-600 rounded-lg p-4 bg-gray-700/50 hover:bg-gray-700/70 transition-all duration-300">
          <h3 className="text-xl font-medium text-teal-300">Master of Science in Data Science & Artificial Intelligence</h3>
        ...
        <div className="border border-teal-600 rounded-lg p-4 bg-gray-700/50 hover:bg-gray-700/70 transition-all duration-300">
          <h3 className="text-xl font-medium text-teal-300">Bachelor of Technology in Electronics and Communication Engineering</h3>
