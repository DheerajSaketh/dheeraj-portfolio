export default function Education() {
  return (
    <section id="education" className="border-2 border-pink-500">
      <h2 className="text-3xl font-semibold mb-6 text-pink-400">Education</h2>

      <div className="border border-pink-600 rounded-lg p-4 bg-gray-700">
        <h3 className="text-xl font-medium text-pink-300">Master of Science in Data Science & Artificial Intelligence</h3>
        <p className="text-gray-100">University of Central Missouri • Jan 2024 – Dec 2025</p>
